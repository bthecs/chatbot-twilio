...
def get_all_data():
    url = "https://08d4-207-248-125-79.ngrok-free.app/get-all-data"
    total_mensajes = requests.get(url)
    url_2 = "https://08d4-207-248-125-79.ngrok-free.app/get-filter-data"
    json_data = {"value": "contactar con asesor","column": "usage_interest"}
    ...
    url_3 = "https://08d4-207-248-125-79.ngrok-free.app/get-column-data"
