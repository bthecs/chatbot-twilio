...
def arbol():
    ...
    # Agregar más nodos y bordes según tu lógica

    # Crear la interfaz de streamlit
    st.title("Arbol de Mensajes")

    # Dibujar el grafo y mostrarlo en Streamlit
    pos = nx.spring_layout(G)  # Elegir una disposición de nodos
    nx.draw(G, pos, with_labels=True, node_size=3000, node_color="skyblue", font_size=8, font_color="black", arrows=True)
    plt.axis("off")
    plt.tight_layout()
